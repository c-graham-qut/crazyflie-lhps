...
It is a simple example of a swarm using the High Level Commander in the
Crazyflie Python Library to command a drone swarm to perform several
flight patterns.

The swarm takes off and flied a defined shape before landing.
